...
TREESALL = "--xf THQ_LHE,THW_LHE,TTTW,TTWH --FMCs {P}/0_jmeUnc_v1  --Fs {P}/1_recl_allvars --FMCs {P}/2_btag_SFs --FMCs {P}/2_scalefactors_lep_fixed --Fs {P}/3_tauCount --Fs {P}/4_evtVars  --Fs {P}/5_BDThtt_reco_new_blah --Fs {P}/6_mva2lss --Fs {P}/6_mva3l --Fs {P}/6_mva_2lss1tau --FMCs {P}/6_mva_tauSFs   --Fs {P}/6_mva4l --Fs {P}/7_mvaCP_2lss --Fs {P}/7_mvaCP_2lss1tau  --Fs {P}/7_mvaCP_3l "  #_new
