...
T2L="-P {ORIGIN}/NanoTrees_TTH_090120_091019_v6_skim2lss/{YEAR} --FMCs {{P}}/0_jmeUnc_v1  --Fs {{P}}/1_recl_allvars --FMCs {{P}}/2_btag_SFs --FMCs {{P}}/2_scalefactors_lep_fixed --Fs {{P}}/3_tauCount --Fs {{P}}/4_evtVars --Fs {{P}}/5_BDThtt_reco_new_blah --Fs {{P}}/6_mva2lss --Fs {{P}}/6_mva3l --Fs {{P}}/6_mva4l --Fs {{P}}/6_mva_2lss1tau_new --FMCs {{P}}/6_mva_tauSFs  --xf TTTW --xf TTWH".format(ORIGIN=ORIGIN, YEAR=YEAR)
if "_CP" in REGION:
   T2L="-P {ORIGIN}/NanoTrees_TTH_090120_091019_v6_skim2lss_forCP/{YEAR} --FMCs {{P}}/0_jmeUnc_v1  --Fs {{P}}/1_recl_allvars --FMCs {{P}}/2_btag_SFs --FMCs {{P}}/2_scalefactors_lep_fixed --Fs {{P}}/3_tauCount --Fs {{P}}/4_evtVars --Fs {{P}}/5_BDThtt_reco_new_blah --Fs {{P}}/6_mva2lss --Fs {{P}}/6_mva3l --Fs {{P}}/6_mva4l --Fs {{P}}/6_mva_2lss1tau_new --FMCs {{P}}/6_mva_tauSFs --Fs {{P}}/7_mvaCP_2lss --Fs {{P}}/7_mvaCP_2lss1tau  --Fs {{P}}/7_mvaCP_3l  --FMCs {{P}}/A_thqweights --xf TTTW --xf TTWH".format(ORIGIN=ORIGIN, YEAR=YEAR)
if "_CP_newmodel" in REGION:
   T2L="-P {ORIGIN}/NanoTrees_TTH_090120_091019_v6_skim2lss_forCP/{YEAR} --FMCs {{P}}/0_jmeUnc_v1  --Fs {{P}}/1_recl_allvars --FMCs {{P}}/2_btag_SFs --FMCs {{P}}/2_scalefactors_lep_fixed --Fs {{P}}/3_tauCount --Fs {{P}}/4_evtVars --Fs {{P}}/5_BDThtt_reco_new_blah --Fs {{P}}/6_mva2lss --Fs {{P}}/6_mva3l --Fs {{P}}/6_mva4l --Fs {{P}}/6_mva_2lss1tau_new --FMCs {{P}}/6_mva_tauSFs --Fs {{P}}/7_mvaCP_2lss --Fs {{P}}/7_mvaCP_2lss1tau  --Fs {{P}}/7_mvaCP_3l  --xf TTTW --xf TTWH  --filter ttH-multilepton/loosernewfilter.txt".format(ORIGIN=ORIGIN, YEAR=YEAR)
...
if "_CP_newmodel" in REGION:         
    ASIMOV="--asimov ttH_SM_hww,ttH_SM_hzz,ttH_SM_tt,ttH_SM_hmm,ttH_SM_hzg,tHq_SM_hww,tHq_SM_hzz,tHq_SM_htt,tHW_SM_hww,tHW_SM_hzz,tHW_SM_htt,ZH_hww,ZH_htt,ZH_hzz,WH_hww,WH_htt,WH_hzz,qqH_hzz"
    SCRIPT = "makeShapeCardsNew.py"
    MCAOPTION="-CP_new"
    SYSTS="--unc ttH-multilepton/systsUnc.txt --amc"
    SREGEXP =""
...
FUNCTION_2L1TAU_CP="ttH_catIndex_2lss1tau_CP(DNN_2lss1tau_predictions_ttH,DNN_2lss1tau_predictions_tH,DNN_2lss1tau_predictions_rest,1. / (1. + TMath::Sqrt((1. - mvaCP_2lss1tau)/(1. + mvaCP_2lss1tau))))"
...
if REGION == "2lss_CP" or REGION == "2lss_CP_newmodel":
    OPT_2L='{T2L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*leptonSF_2lss*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 2, year)"'.format(T2L=T2L, OPTIONS=OPTIONS)
    CATPOSTFIX=""

    CATBINS="[0.5,1.5,2.5,3.5,4.5,5.5,6.5,7.5,8.5,9.5,10.5,11.5,12.5,13.5,14.5,15.5,16.5,17.5,18.5,19.5,20.5,21.5,22.5,23.5,24.5,25.5,26.5,27.5,28.5,29.5,30.5,31.5,32.5,33.5,34.5,35.5,36.5,37.5,38.5,39.5,40.5,41.5,42.5,43.5,44.5,45.5,46.5,47.5,48.5,49.5,50.5,51.5,52.5,53.5,54.5,55.5,56.5,57.5,58.5,59.5,60.5,61.5,62.5,63.5,64.5,65.5,66.5,67.5,68.5,69.5,70.5,71.5,72.5,73.5,74.5,75.5,76.5,77.5,78.5,79.5,80.5,81.5,82.5,83.5,84.5,85.5,86.5,87.5,88.5,89.5,90.5,91.5,92.5,93.5,94.5,95.5,96.5,97.5,98.5,99.5,100.5,101.5,102.5,103.5,104.5,105.5,106.5,107.5,108.5,109.5,110.5,111.5,112.5,113.5,114.5,115.5,116.5,117.5,118.5,119.5,120.5,121.5,122.5,123.5,124.5,125.5,126.5,127.5,128.5,129.5,130.5,131.5,132.5,133.5,134.5,135.5,136.5,137.5,138.5,139.5,140.5,141.5]"
    RANGES = '[1,53,61,67,71,79,98,109,120,135,142]'
    NAMES  = ','.join( '%s_%s'%(x,YEAR) for x in 'ee_em_mm_ttHnode,ee_Restnode,ee_ttWnode,ee_tHQnode,em_Restnode,em_ttWnode,em_tHQnode,mm_Restnode,mm_ttWnode,mm_tHQnode'.split(','))
            
    TORUN='''python {SCRIPT} {DOFILE} ttH-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttH-multilepton/2lss_tight_legacy.txt "{FUNCTION_2L}" "{CATBINS}" {SYSTS} {OPT_2L} --binname ttH_2lss_0tau --year {YEAR} --categorize-by-ranges {RANGES} {NAMES} {EXTRA_CP} --UP'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_2L=FUNCTION_2L_CP, CATBINS=CATBINS, SYSTS=SYSTS, OPT_2L=OPT_2L,YEAR=YEAR,RANGES=RANGES,NAMES=NAMES,EXTRA_CP=SREGEXP+PARAM)
    print submit.format(command=TORUN)
...
if REGION == "2lss1tau_CP" or  REGION == "2lss1tau_CP_newmodel":
    OPT_2L='{T2L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*leptonSF_2lss*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 2, year)*TauSel_2lss1tau_SF"'.format(T2L=T2L, OPTIONS=OPTIONS)
    CATPOSTFIX=""
    ...
    TORUN='''python {SCRIPT} {DOFILE} ttH-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttH-multilepton/2lss_1ltau.txt "{FUNCTION_2L1TAU}" "{CATBINS}" {SYSTS} {OPT_2L} --binname ttH_2lss_1tau --year {YEAR} --categorize-by-ranges {RANGES} {NAMES} {EXTRA_CP} --UP'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_2L1TAU=FUNCTION_2L1TAU_CP, CATBINS=CATBINS, SYSTS=SYSTS, OPT_2L=OPT_2L,YEAR=YEAR,RANGES=RANGES,NAMES=NAMES,EXTRA_CP=SREGEXP+PARAM)
    print(submit.format(command=TORUN))
...
if REGION == "3l_CP" or REGION == "3l_CP_newmodel":
    OPT_3L='{T3L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 3, year)*leptonSF_3l"'.format(T3L=T3L, OPTIONS=OPTIONS)
    CATPOSTFIX=""
    ...
    NAMES  = ','.join( '%s_%s'%(x,YEAR) for x in ['ttH_bl','ttH_bt','tH_bl','tH_bt','rest_eee','rest_eem_bl','rest_eem_bt','rest_emm_bl','rest_emm_bt','rest_mmm_bl','rest_mmm_bt'])
    TORUN = 'python {SCRIPT} {DOFILE} ttH-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttH-multilepton/3l_tight_legacy.txt "{FUNCTION_3L}" "{CATBINS}" {SYSTS} {OPT_3L} --binname ttH_3l_0tau --year {YEAR} --categorize-by-ranges {RANGES} {NAMES} {EXTRA_CP} --UP'.format(SCRIPT=SCRIPT, DOFILE=DOFILE,MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION,FUNCTION_3L=FUNCTION_3L_CP,CATBINS=CATBINS,YEAR=YEAR, SYSTS=SYSTS, OPT_3L=OPT_3L,RANGES=RANGES, NAMES=NAMES,EXTRA_CP=SREGEXP+PARAM)
    print( submit.format(command=TORUN))
...
if  REGION == "cr_3l_CP" or  REGION == "cr_3l_CP_newmodel":
    OPT_3L='{T3L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 3, year)*leptonSF_3l"'.format(T3L=T3L,OPTIONS=OPTIONS)
    CATPOSTFIX="_cr"
    ...
    TORUN = '''python {SCRIPT} {DOFILE} ttH-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttH-multilepton/3l_tight_legacy.txt {FUNCTION_CR_3L} {SYSTS} {OPT_3L} --binname ttH_cr_3l_{YEAR} --categorize "{CATFUNC}" {CATBINS} {CATNAMES} --year {YEAR} {EXTRA_CP} --UP'''.format( SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION,FUNCTION_CR_3L=FUNCTION_CR_3L,SYSTS=SYSTS,OPT_3L=OPT_3L,YEAR=YEAR,CATFUNC=CATFUNC,CATBINS=CATBINS,CATNAMES=CATNAMES,EXTRA_CP=SREGEXP+PARAM)
    print(submit.format(command=TORUN))

if REGION == "cr_4l_CP" or REGION == "cr_4l_CP_newmodel":
    ...
    CATPOSTFIX="_cr_4l";
    TORUN = 'python {SCRIPT} {DOFILE} ttH-multilepton/mca-4l-{MCASUFFIX}{MCAOPTION}.txt ttH-multilepton/4l_tight.txt {FUNCTION_CR_4L} {SYSTS} {OPT_4L} --binname ttH{CATPOSTFIX}_{YEAR} --year {YEAR} {EXTRA_CP} --UP'.format(SCRIPT=SCRIPT, DOFILE=DOFILE,MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION, FUNCTION_CR_4L=FUNCTION_CR_4L,SYSTS=SYSTS,OPT_4L=OPT_4L,CATPOSTFIX=CATPOSTFIX,YEAR=YEAR,EXTRA_CP=SREGEXP+PARAM)
    print(submit.format(command=TORUN))
